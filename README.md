[![Run App KyleWydrinski](https://github.com/kwydrinski2/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/kwydrinski2/GithubActions/actions/workflows/run-app.yaml)
